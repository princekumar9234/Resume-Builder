...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-50 ">
      <div className="flex justify-between border bg-[#e0eee0] border-gray-500 m-3 mt-3 rounded-2xl  backdrop-blur-md shadow-md items-center py-4 px-6">
        {/* Logo */}
        <div className="font-bold text-2xl flex items-center whitespace-nowrap gap-2">
          <span>Resume</span> <span className="text-yellow-600">Builder</span>
        </div>
